'''
Auto Job Applier for LinkedIn - Chrome launcher
...
try:
    ...
    msg = 'Seems like Google Chrome is out dated. Update browser and try again! If issue persists, try Safe Mode. Set safe_mode = True in config/settings.py'
