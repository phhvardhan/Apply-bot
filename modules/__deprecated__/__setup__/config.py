'''
Auto Job Applier for LinkedIn - Deprecated setup config
...
first_name = "First"               # Your first name in quotes
middle_name = ""                   # Your middle name in quotes
last_name = "Last"                 # Your last name in quotes
