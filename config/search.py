'''
Auto Job Applier for LinkedIn - Search config
...
# Avoid applying to jobs that have these bad words in their 'Job Description' (case-insensitive).
# Use this to skip: citizenship requirements, no-sponsorship jobs, security clearance, or any other deal-breaker phrases.
bad_words = [
    # Citizenship / work authorization requirements (skip jobs that require citizen or similar)
    "US Citizen", "USA Citizen", "U.S. Citizen", "U.S. citizenship required", "US citizenship required",
    "citizenship required", "must be a U.S. citizen", "must be a US citizen", "U.S. Citizenship",
    "No C2C", "No Corp2Corp",
    # No visa sponsorship (skip jobs that explicitly say they will NOT sponsor – for international grads seeking sponsorship)
    "without requiring sponsorship",
    "do not require sponsorship", "will not sponsor", "no visa sponsorship", "no sponsorship",
    "must have work authorization that does not", "without sponsor", "eligible to work in the US without requiring sponsorship",
    "Lawful Permanent Residence or US Citizen",
    # Security clearance (skip unless you have security_clearance = True below)
    "Security Clearance", "security clearance required", "active security clearance",
    "eligible for security clearance", "must have clearance", "polygraph", "Secret clearance", "Top Secret", "TS/SCI",
    # Other skills/roles you want to skip (add or remove as needed)
]

# Do you have an active Security Clearance? (True = apply to clearance jobs, False = skip any job mentioning clearance/polygraph/secret/top secret)
