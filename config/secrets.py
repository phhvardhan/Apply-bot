'''
Auto Job Applier for LinkedIn - Secrets config
...
username = "phhvardhan2@gmail.com"       # Enter your username in the quotes
password = "Harshavardhan99*"           # Enter your password in the quotes
