'''
Auto Job Applier for LinkedIn - Personals config
...
# Your legal name
first_name = "Hema Harsha Vardhan"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Peela"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "6827102185"        # Enter your 10 digit number in quotes Eg: "9876543210"
...
street = "935 Haight Street"          # Street address in quotes Eg: "123 Main Street"
state = "California"
zipcode = "94117"
